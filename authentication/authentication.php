...
<head>
    ...
    <link rel="icon" type="image/png" href="/NoteShare/assets/images/logo.png">
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <link rel="stylesheet" href="/NoteShare/assets/css/authentication.css">
...
<video autoplay muted loop playsinline preload="auto" class="background-video">
    <source src="/NoteShare/assets/images/tablet.mp4" type="video/mp4">
...
<div class="wrapper">
    <nav class="nav">
        <div class="nav-logo">
            <img src="/NoteShare/assets/images/logo.png" alt="Logo">
            <p>NoteShare</p>
        </div>
    ...
    <div class="form-box">
        ...
        <div class="login-container" id="login">
            ...
            <form id="loginForm">
                ...
                <div class="input-box">
                    <input type="password" class="input-field password-input" id="loginPassword" name="password" placeholder="Password" required>
                    <i class="bx bx-eye password-toggle" id="loginPasswordToggle" onclick="togglePassword('loginPassword', 'loginPasswordToggle')"></i>
                </div>
                <div class="input-box">
        ...
        <div class="register-container" id="register">
            ...
            <form id="registerForm">
                ...
                <div class="input-box">
                    <input type="password" class="input-field password-input" id="registerPassword" name="password" placeholder="Password" required>
                    <i class="bx bx-eye password-toggle" id="registerPasswordToggle" onclick="togglePassword('registerPassword', 'registerPasswordToggle')"></i>
                </div>
                <div class="input-box">
...
<script>
    ...
    function login() {
        ...
        // Reset password icons to default (eye icon for hidden password)
        syncPasswordIcon('loginPassword', 'loginPasswordToggle');
    }
    ...
    function register() {
        ...
        // Reset password icons to default (eye icon for hidden password)
        syncPasswordIcon('registerPassword', 'registerPasswordToggle');
    }
    ...
    function togglePassword(inputId, toggleId) {
        ...
        if (inputEl.type === 'password') {
            inputEl.type = 'text';
            toggleEl.classList.remove('bx-eye');
            toggleEl.classList.add('bx-eye-off');
        } else {
            inputEl.type = 'password';
            toggleEl.classList.remove('bx-eye-off');
            toggleEl.classList.add('bx-eye');
        }
    }

    // Sync password icon with input state (called when form resets)
    function syncPasswordIcon(inputId, toggleId) {
        const inputEl = document.getElementById(inputId);
        const toggleEl = document.getElementById(toggleId);
    ...
    document.getElementById('loginForm').addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (data.success) {
                ...
                document.getElementById('loginForm').reset();
                setTimeout(() => {
                    window.location.href = '/NoteShare/home.html';
                }, 1500);
            } else {
